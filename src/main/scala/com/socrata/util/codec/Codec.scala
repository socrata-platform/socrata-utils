...
object Codecs {
  ...
  implicit def ArrayCodec[T : Codec : ClassTag]: Codec[Array[T]] = new Codec[Array[T]] {
  ...
  implicit def SeqCodec[T, S[X] <: Seq[X]](implicit tCodec: Codec[T], buildFactory: CB[T, S[T]]): Codec[S[T]] = new Codec[S[T]] {
